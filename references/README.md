...
1. [[specification/README|Specification formally]].
2. [[notes/decisions/README|Decisions currently in force]] and its ADRs.
3. [[notes/questions/README|Active questions]].

The snapshots and audits that have been removed are stored in the Git history. Evidence of the end of their migration is recorded in [[notes/questions/Q-010-e-state-of-source-decisions|Q-010]].
