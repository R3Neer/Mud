...
[[notes/decisions/ADR-014-ontologia-unificada-de-things|ADR-014]] provides that every `thing` A concrete thing is simultaneously a thing with state its own and a possible ancestor. This makes it necessary to clarify:
