...
Una magnitud `point over` puede habilitar escrituras contextuales mediante su metadato `~format`, por ejemplo `12:30:00`. El lexer representa una coincidencia válida como `POINT_LITERAL`.
