CREATE TABLE validation_requests_v2 (
    request_id TEXT PRIMARY KEY,
    schema_version INTEGER NOT NULL CHECK (schema_version = 1),
    transport_kind TEXT NOT NULL CHECK (
        transport_kind IN ('zip_base64', 'logical_files', 'files_staged_v1')
    ),
...
INSERT INTO validation_requests_v2
SELECT * FROM validation_requests;

CREATE TABLE validation_events_v2 (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    request_id TEXT NOT NULL REFERENCES validation_requests_v2(request_id),
    event TEXT NOT NULL,
    detail_json TEXT NOT NULL,
    created_at TEXT NOT NULL
);

INSERT INTO validation_events_v2
SELECT * FROM validation_events;

DROP TABLE validation_events;
DROP TABLE validation_requests;
ALTER TABLE validation_requests_v2 RENAME TO validation_requests;
ALTER TABLE validation_events_v2 RENAME TO validation_events;
