...
Su ancla canónica es `thing::Thing`; `Thing~anchor` devuelve ese valor reflectivo. El ancla pertenece al lenguaje y no ocupa un path declarable por el programa. La forma especial `anchor{...}` dejó de existir con D-085.
