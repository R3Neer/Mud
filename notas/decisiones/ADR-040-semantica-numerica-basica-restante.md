...
Una operación aritmética ordinaria que produciría un entero negativo bajo representación `Natural` satura en cero antes de comprobar el dominio declarado.
...
3. Saturación aritmética de `Natural` y no saturación de `to Natural`.
