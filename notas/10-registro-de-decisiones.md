...
| D-039 | Vigente | Las colecciones conservan multiplicidad salvo `unique`, admiten claves `ordered by` sobre familias ordenadas y consolidan idempotentemente inserciones repetidas bajo `unique` | [ADR-039](decisiones/ADR-039-colecciones-y-diccionarios.md) | Migración normativa de las secciones 16 a 18; unicidad, avisos y claves de familia precisados por decisión del autor el 2026-07-28 |
