...
| D-050 | Vigente | MUD usa salto o `;` como terminador; un salto solo continúa un prefijo sintácticamente incompleto y la sangría es irrelevante | [ADR-050](decisiones/ADR-050-comentarios-terminadores-y-separadores-numericos.md) | Migración normativa de las secciones 30, 60 y 61 |
