...
| D-049 | Vigente | La lógica usa `not`, `and`, `or`, `xor`, `=>` y `<=>`; intervalos y colecciones reservan `|`, `&`, `^` y `-` | [ADR-049](decisiones/ADR-049-operadores-precedencia-e-intervalos-normalizados.md) | Migración normativa de las secciones 27 a 29; escrituras canónicas únicas decididas por el autor el 2026-07-29 |
