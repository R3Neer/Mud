...
| D-038 | Vigente | `family` declara tipos nominales finitos con datos inmutables; una `ordered family` puede aportar esos datos como claves de colección | [ADR-038](decisiones/ADR-038-familias-cerradas-de-valores.md) | Migración normativa de la sección 12; esquema y claves de orden completados por decisión del autor el 2026-07-28 |
