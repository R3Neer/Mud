...
| D-016 | Vigente | `create thing` puede activar identidades raíz, abstractas o con varias antecesoras mediante `as` | [ADR-016](decisiones/ADR-016-creacion-generalizada-de-things.md) | Decisión del autor, 2026-07-27; vocabulario actualizado por D-025 |
...
| D-023 | Vigente | Los `then` conservan secuencialidad local y consolidan efectos estructurales de forma determinista; los fragmentos compatibles de una `thing` se fusionan | [ADR-023](decisiones/ADR-023-consolidacion-de-efectos-estructurales.md) | Decisión del autor, 2026-07-27 |
| D-024 | Vigente para reglas; aliases sustituidos por D-031 | Cada regla tiene una única definición completa; `create Nombre` activa su descriptor canónico y las activaciones concurrentes se consolidan | [ADR-024](decisiones/ADR-024-definicion-unica-y-activacion-abreviada.md) | Decisión del autor, 2026-07-27 |
...
| D-028 | Vigente, ampliada por D-034 | Los tipos numéricos básicos representan números; las magnitudes aportan dimensión y derivan automáticamente unidades compatibles | [ADR-028](decisiones/ADR-028-sistema-de-magnitudes-y-unidades.md) | Decisión del autor, 2026-07-28 |
