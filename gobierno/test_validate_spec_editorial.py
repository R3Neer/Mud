...
def run_case(root: Path, name: str, content: str, expected: set[str]) -> None:
    target = root / "especificacion" / f"{name}.md"
...
def main() -> int:
    with tempfile.TemporaryDirectory() as temporary:
        root = Path(temporary)
        write(root / "notas/preguntas/Q-001-activa.md", question("Q-001", "false"))
        write(root / "notas/preguntas/Q-002-cerrada.md", question("Q-002", "true"))
        write(
            root / "especificacion/00-convenciones-editoriales.md",
        ...
        mechanical = root / "especificacion/nombres/fixture.asdl"
